...
> zip2john secure.zip > zip\_hash.txt
...
> rar2john secure.rar > rar\_hash.txt
...
Use **SSH2John** converts the id\_rsa private key that you use to login to the SSH session into hash format

> python ssh2john.py idrsa.id\_rsa > id\_rsa\_hash.txt

> john --wordlist=/usr/share/wordlists/rockyou.txt id\_rsa\_hash.txt
